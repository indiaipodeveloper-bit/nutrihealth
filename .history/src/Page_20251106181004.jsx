...
export default function BiteBliss() {
  return (
    <div className="min-h-screen bg-[#f8f1e2]">
      {/* HEADER */}
      <header className="bg-[#f8f1e2] border-b-4 border-[#8b4513]">
        <div className="max-w-7xl mx-auto px-4 py-6 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            ...
            <button className="bg-[#e76f51] text-white px-6 py-3 font-bold">
              Order Now
            </button>
          </nav>
        </div>
      ...
      <section className="bg-[#f8f1e2] py-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <button className="bg-[#e76f51] text-white px-10 py-4 text-xl font-bold">
            View Menu
          </button>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[1, 2, 3, 4].map((item) => (
              <div
                key={item}
                className="border-4 border-[#8b4513] p-8 flex items-center gap-6"
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-[#8b4513] text-white px-6 py-2 font-bold">
                      Order
                    </button>
                  </div>
                </div>
