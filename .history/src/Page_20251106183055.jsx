    ...
    <div className="min-h-screen bg-[#f8f1e2]">
      ...
      <section className="bg-[#f8f1e2] py-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <button className="bg-[#e76f51] hover:rounded-4xl transition-all duration-300 rounded-sm== text-white px-10 py-4 text-xl font-bold hover:opacity-90  cursor-pointer">
            View Menu
          </button>
        </div>
      </section>
