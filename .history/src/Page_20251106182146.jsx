...
export default function BiteBliss() {
  return (
    <div className="min-h-screen bg-[#f8f1e2]">
      {/* HEADER */}
      <header className="bg-[#f8f1e2] border-b border-[#8b4513]/30">
        <div className="max-w-7xl mx-auto px-4 py-6 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            <a href="#" className="text-[#8b4513] font-semibold hover:text-[#e76f51] transition">
              Menu
            </a>
            <a href="#" className="text-[#8b4513] font-semibold hover:text-[#e76f51] transition">
              About
            </a>
            <button className="bg-[#e76f51] text-white px-6 py-3 font-bold hover:opacity-90 transition cursor-pointer">
              Order Now
            </button>
          </nav>
        </div>
      ...
      <section className="bg-[#f8f1e2] py-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <button className="bg-[#e76f51] text-white px-10 py-4 text-xl font-bold hover:opacity-90 transition cursor-pointer">
            View Menu
          </button>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[1, 2, 3, 4].map((item) => (
              <div
                key={item}
                className="bg-white shadow-lg hover:shadow-xl transition rounded-xl p-8 flex items-center gap-6 cursor-pointer hover:-translate-y-1"
              >
                <div className="bg-[#8b4513]/90 w-32 h-32 flex items-center justify-center flex-shrink-0 rounded-lg">
