    ...
    <>
      <div className="fixed z-10">
        ...
        <div
          ...
          } z-10 min-w-[250px] md:hidden top-0 left-0 relative`}
        >
          <button
        ...
        {/* ------------------------top bar -------------------------------- */}
        <div className="fixed px-5 hidden sm:block py-2.5 top-0 z-20 bg- w-full bg-white border-b border-b-gray-200 ">
